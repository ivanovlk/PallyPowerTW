...
if ( GetLocale() == "esES" ) then
    ...
    PallyPower_SealID = { };
    PallyPower_SealID[0] = "Luz";
    PallyPower_SealID[1] = "Sabiduría";
    PallyPower_SealID[2] = "Comando";
    PallyPower_SealID[3] = "Rectitud";
    PallyPower_SealID[4] = "Justicia";
    PallyPower_SealID[5] = "el Cruzado";
